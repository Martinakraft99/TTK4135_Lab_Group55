...
#ifndef RTW_HEADER_helicopterD2_h_
#define RTW_HEADER_helicopterD2_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopterD2_COMMON_INCLUDES_
#define helicopterD2_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* helicopterD2_COMMON_INCLUDES_ */

#include "helicopterD2_types.h"
...
#define helicopterD2_rtModel           RT_MODEL_helicopterD2_T
...
#define rtB                            helicopterD2_B
#define BlockIO                        B_helicopterD2_T
#define rtX                            helicopterD2_X
#define ContinuousStates               X_helicopterD2_T
#define rtXdot                         helicopterD2_XDot
#define StateDerivatives               XDot_helicopterD2_T
#define tXdis                          helicopterD2_XDis
#define StateDisabled                  XDis_helicopterD2_T
#define rtP                            helicopterD2_P
#define Parameters                     P_helicopterD2_T
#define rtDWork                        helicopterD2_DW
#define D_Work                         DW_helicopterD2_T

/* Parameters (default storage) */
struct P_helicopterD2_T_ {
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T Gain_Gain_lg;                 /* Expression: 180/pi
...
extern P_helicopterD2_T helicopterD2_P;

/* Block signals (default storage) */
extern B_helicopterD2_T helicopterD2_B;

/* Continuous states (default storage) */
extern X_helicopterD2_T helicopterD2_X;

/* Block states (default storage) */
extern DW_helicopterD2_T helicopterD2_DW;

/* Model entry point functions */
extern void helicopterD2_initialize(void);
extern void helicopterD2_output(void);
extern void helicopterD2_update(void);
extern void helicopterD2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopterD2_rtModel *helicopterD2(void);
...
extern RT_MODEL_helicopterD2_T *const helicopterD2_M;
 ...
 *
 * '<Root>' : 'helicopterD2'
 * '<S1>'   : 'helicopterD2/Conversion'
 * '<S2>'   : 'helicopterD2/Degrees to Radians'
 * '<S3>'   : 'helicopterD2/Elevation controller'
 * '<S4>'   : 'helicopterD2/Helicopter_interface'
 * '<S5>'   : 'helicopterD2/Pitch controller'
 * '<S6>'   : 'helicopterD2/Radians to Degrees'
 * '<S7>'   : 'helicopterD2/Elevation controller/If Action Subsystem'
 * '<S8>'   : 'helicopterD2/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopterD2/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopterD2/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopterD2/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopterD2/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopterD2/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopterD2/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopterD2_h_ */
