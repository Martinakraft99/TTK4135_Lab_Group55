...
#endif                                 /* helicopterD3_COMMON_INCLUDES_ */

#include "helicopterD3_types.h"
...
#define helicopterD3_rtModel           RT_MODEL_helicopterD3_T
...
#define rtB                            helicopterD3_B
#define BlockIO                        B_helicopterD3_T
#define rtX                            helicopterD3_X
#define ContinuousStates               X_helicopterD3_T
#define rtXdot                         helicopterD3_XDot
#define StateDerivatives               XDot_helicopterD3_T
#define tXdis                          helicopterD3_XDis
#define StateDisabled                  XDis_helicopterD3_T
#define rtP                            helicopterD3_P
#define Parameters                     P_helicopterD3_T
#define rtDWork                        helicopterD3_DW
#define D_Work                         DW_helicopterD3_T

/* Parameters (default storage) */
struct P_helicopterD3_T_ {
...
extern P_helicopterD3_T helicopterD3_P;

/* Block signals (default storage) */
extern B_helicopterD3_T helicopterD3_B;

/* Continuous states (default storage) */
extern X_helicopterD3_T helicopterD3_X;

/* Block states (default storage) */
extern DW_helicopterD3_T helicopterD3_DW;

/* Model entry point functions */
extern void helicopterD3_initialize(void);
extern void helicopterD3_output(void);
extern void helicopterD3_update(void);
extern void helicopterD3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopterD3_rtModel *helicopterD3(void);
...
extern RT_MODEL_helicopterD3_T *const helicopterD3_M;
 ...
 *
 * '<Root>' : 'helicopterD3'
 * '<S1>'   : 'helicopterD3/Conversion'
 * '<S2>'   : 'helicopterD3/Degrees to Radians'
 * '<S3>'   : 'helicopterD3/Elevation controller'
 * '<S4>'   : 'helicopterD3/Helicopter_interface'
 * '<S5>'   : 'helicopterD3/Pitch controller'
 * '<S6>'   : 'helicopterD3/Subsystem'
 * '<S7>'   : 'helicopterD3/Elevation controller/If Action Subsystem'
 * '<S8>'   : 'helicopterD3/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopterD3/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopterD3/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopterD3/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopterD3/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopterD3/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopterD3/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopterD3_h_ */
