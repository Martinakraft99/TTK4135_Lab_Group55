...
#ifndef RTW_HEADER_helicopterD4_h_
#define RTW_HEADER_helicopterD4_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopterD4_COMMON_INCLUDES_
#define helicopterD4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* helicopterD4_COMMON_INCLUDES_ */

#include "helicopterD4_types.h"
...
#define helicopterD4_rtModel           RT_MODEL_helicopterD4_T
...
typedef struct {
  ...
  real_T x[6];                         /* '<S6>/From Workspace1' */
  real_T Sum_n[6];                     /* '<S6>/Sum' */
  real_T Kxx[2];                       /* '<S6>/Gain' */
  real_T u[2];                         /* '<Root>/Sum3' */
...
#define rtB                            helicopterD4_B
#define BlockIO                        B_helicopterD4_T
#define rtX                            helicopterD4_X
#define ContinuousStates               X_helicopterD4_T
#define rtXdot                         helicopterD4_XDot
#define StateDerivatives               XDot_helicopterD4_T
#define tXdis                          helicopterD4_XDis
#define StateDisabled                  XDis_helicopterD4_T
#define rtP                            helicopterD4_P
#define Parameters                     P_helicopterD4_T
#define rtDWork                        helicopterD4_DW
#define D_Work                         DW_helicopterD4_T

/* Parameters (default storage) */
struct P_helicopterD4_T_ {
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T Pi_Value;                     /* Expression: 180
...
extern P_helicopterD4_T helicopterD4_P;

/* Block signals (default storage) */
extern B_helicopterD4_T helicopterD4_B;

/* Continuous states (default storage) */
extern X_helicopterD4_T helicopterD4_X;

/* Block states (default storage) */
extern DW_helicopterD4_T helicopterD4_DW;

/* Model entry point functions */
extern void helicopterD4_initialize(void);
extern void helicopterD4_output(void);
extern void helicopterD4_update(void);
extern void helicopterD4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopterD4_rtModel *helicopterD4(void);
...
extern RT_MODEL_helicopterD4_T *const helicopterD4_M;
 ...
 *
 * '<Root>' : 'helicopterD4'
 * '<S1>'   : 'helicopterD4/Conversion'
 * '<S2>'   : 'helicopterD4/Degrees to Radians'
 * '<S3>'   : 'helicopterD4/Elevation controller'
 * '<S4>'   : 'helicopterD4/Helicopter_interface'
 * '<S5>'   : 'helicopterD4/Pitch controller'
 * '<S6>'   : 'helicopterD4/Subsystem'
 * '<S7>'   : 'helicopterD4/Elevation controller/If Action Subsystem'
 * '<S8>'   : 'helicopterD4/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopterD4/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopterD4/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopterD4/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopterD4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopterD4/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopterD4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopterD4_h_ */
